package com.nexus.shared.userprofile.entity;
...
public class UserProfile {
     ...
     * Unique constraint ensures one profile per user per domain
     */
     ...
     * Used in conjunction with user_id for multi-domain support
     */
