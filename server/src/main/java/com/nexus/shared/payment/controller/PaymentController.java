package com.nexus.shared.payment.controller;

import com.nexus.shared.payment.model.request.CreateOrderRequest;
...
import com.nexus.shared.payment.model.response.CreateOrderResponse;
...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<CreateOrderResponse>> createOrder(
        ...
        CreateOrderResponse response = paymentService.createOrder(userId, domainId, tenantId, request);
    ...
    public ResponseEntity<ApiResponse<PaymentResponse>> processPayment(
        ...
        PaymentResponse response = paymentService.processPayment(userId, domainId, tenantId, request);
        return ResponseEntity.status(HttpStatus.CREATED)
    ...
    public ResponseEntity<ApiResponse<PaymentResponse>> refundPayment(
        ...
        PaymentResponse response = paymentService.refundPayment(userId, domainId, tenantId, roles, request);
    ...
    public ResponseEntity<ApiResponse<PaymentMethodResponse>> savePaymentMethod(
        ...
        PaymentMethodResponse response = paymentService.savePaymentMethod(userId, domainId, tenantId, request);
        return ResponseEntity.status(HttpStatus.CREATED)
    ...
    public ResponseEntity<ApiResponse<List<PaymentMethodResponse>>> getPaymentMethods(
        ...
        List<PaymentMethodResponse> response = paymentService.getPaymentMethods(userId, domainId, tenantId);
    ...
    public ResponseEntity<Void> deletePaymentMethod(
        ...
        paymentService.deletePaymentMethod(userId, domainId, tenantId, paymentMethodId);
    ...
    public ResponseEntity<ApiResponse<Page<PaymentResponse>>> getPaymentHistory(
        ...
        Page<PaymentResponse> response = paymentService.getPaymentHistory(userId, domainId, tenantId, pageable);
    ...
    public ResponseEntity<ApiResponse<PaymentResponse>> getPaymentStatus(
        ...
        PaymentResponse response = paymentService.getPaymentStatus(userId, domainId, tenantId, roles, paymentId);
    ...
    /**
     * Extract domain ID from JWT authentication token
     */
    private UUID getDomainIdFromAuthentication(Authentication authentication) {
        ...
        String domainIdStr = jwtToken.getDomainId();
