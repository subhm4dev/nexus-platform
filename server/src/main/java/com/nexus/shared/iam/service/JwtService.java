...
import com.nexus.shared.iam.repository.JwkKeyRepository;
...
public class JwtService {
    ...
    public String generateAccessToken(UserAccount user, List<String> roles) {
        try {
            ...
            // Get domain_id from tenant (UUID converted to string for JWT)
            String domainId = user.getTenant().getDomainId().toString();
