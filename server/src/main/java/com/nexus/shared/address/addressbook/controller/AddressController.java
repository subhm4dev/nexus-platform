package com.nexus.shared.address.controller;
...
public class AddressController {
    ...
    public ApiResponse<AddressResponse> createAddress(
        ...
        log.info("Creating address for user: {}, domain: {}, tenant: {}", targetUserId, domainId, tenantId);
    ...
    public ApiResponse<AddressResponse> getAddress(
        ...
        log.info("Getting address {} for user: {}, domain: {}, tenant: {}, includeDeleted: {}", 
            addressId, currentUserId, domainId, tenantId, includeDeleted);
    ...
    public ApiResponse<List<AddressResponse>> getUserAddresses(
        ...
        log.info("Getting addresses for user: {}, domain: {}, tenant: {}, includeDeleted: {}", 
            targetUserId, domainId, tenantId, includeDeleted);
    ...
    public ApiResponse<AddressResponse> updateAddress(
        ...
        log.info("Updating address {} for user: {}, domain: {}, tenant: {}", addressId, currentUserId, domainId, tenantId);
    ...
    public ResponseEntity<Void> deleteAddress(
        ...
        log.info("Deleting address {} for user: {}, domain: {}, tenant: {}", addressId, currentUserId, domainId, tenantId);
