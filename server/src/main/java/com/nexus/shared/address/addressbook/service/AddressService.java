package com.nexus.shared.address.service;
...
public interface AddressService {
     ...
     * @param domainId Domain ID from JWT claims
     ...
     * @throws com.nexus.libs.error.exception.BusinessException if duplicate address exists or unauthorized
     */
     ...
     * @param currentUserId Currently authenticated user ID
     * @param domainId Domain ID from JWT claims (UUID)
     * @param tenantId Tenant ID from JWT claims
     * @param roles Current user's roles
     * @param includeDeleted Whether to include deleted addresses (only for admins/staff)
     * @return AddressResponse if found
     * @throws com.nexus.libs.error.exception.BusinessException if address not found or unauthorized
     */
     ...
     * @throws com.nexus.libs.error.exception.BusinessException if unauthorized
     */
