package com.nexus.shared.gateway.config;

import com.nexus.libs.jwt.config.JwtValidationProperties;
...
public class GatewayConfig {
    ...
    public WebClient webClient(JwtValidationProperties jwtProperties) {
        return WebClient.builder()
            .baseUrl(jwtProperties.getJwksUrl().replace("/.well-known/jwks.json", ""))
