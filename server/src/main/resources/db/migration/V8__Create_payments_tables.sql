...
CREATE TABLE payments (
    ...
    domain_id UUID NOT NULL, -- References domains.id - the business domain this payment belongs to
    order_id UUID,
...
CREATE INDEX idx_payment_gateway_transaction_id ON payments(gateway_transaction_id);
CREATE INDEX idx_payments_domain_id ON payments(domain_id);
CREATE INDEX idx_payments_domain_tenant ON payments(domain_id, tenant_id);
...
CREATE TABLE payment_methods (
    ...
    user_id UUID NOT NULL,
    tenant_id UUID NOT NULL,
    domain_id UUID NOT NULL, -- References domains.id - the business domain this payment method belongs to
...
CREATE INDEX idx_payment_methods_domain_id ON payment_methods(domain_id);
CREATE INDEX idx_payment_methods_domain_tenant ON payment_methods(domain_id, tenant_id);
...
-- Add comments
COMMENT ON COLUMN payments.domain_id IS 'References domains.id - the business domain this payment belongs to';
COMMENT ON COLUMN payment_methods.domain_id IS 'References domains.id - the business domain this payment method belongs to';
