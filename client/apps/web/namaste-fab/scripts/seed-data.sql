-- ============================================================================
-- Namaste Fab - Database Seed Script
-- ============================================================================
-- This script creates:
-- 1. Admin user
-- 2. Seller user
-- 3. Categories and subcategories for sarees
-- 4. Sample products with free images
-- ============================================================================

-- ============================================================================
-- 1. CREATE ADMIN USER
-- ============================================================================
-- Note: Password hash is for "Admin@123" (test password)
-- In production, users should register via the API to get proper Argon2 hashes
-- ============================================================================

-- First, ensure the marketplace tenant exists
...
-- For testing, you can use the login API with email: admin@namastefab.com, password: Admin@123
...
VALUES (
    ...
    'dGVzdHNhbHQxMjM0NTY3ODkwYWJjZGVmZ2hpams=', -- Base64 encoded test salt
    '00000000-0000-0000-0000-000000000000'::uuid,
    true,
    true,
    true,
...
-- 4. CREATE PRODUCTS
-- ============================================================================
-- Using free images from Unsplash and Pexels
...
--
-- SELECT * FROM user_accounts WHERE email IN ('admin@namastefab.com', 'seller@namastefab.com');
-- SELECT * FROM role_grants WHERE user_id IN ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb');
