...
import { useProcessManualPayment } from '@/hooks/usePayments';
...
export default function ManualPaymentPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-neutral-900">Manual Payment Entry</h1>
        <p className="text-sm text-neutral-600 mt-1">Record manual payments</p>
      </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(handleSubmitPayment)} className="space-y-4">
              ...
              <Button type="submit" disabled={processMutation.isPending} className="w-full">
                {processMutation.isPending ? 'Recording...' : 'Record Payment'}
              </Button>
            </form>
          </CardContent>
        </Card>
