      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Medications Management Ready</h3>
            <p className="text-gray-600 mb-4">Manage patient medications, prescriptions, and dosage information.</p>
            <Button>Set Up Medications</Button>
          </div>
        </CardContent>
      </Card>
    </div>
